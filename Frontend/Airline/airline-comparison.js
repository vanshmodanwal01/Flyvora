...
airline.addEventListener("click", () => {
    window.location.href = "airline-comparison.html";
});
...
const AIRLINES = [
    { name: 'IndiGo', avgFare: 5120, change30d: 4.1, marketShare: 41.2, color: '#60a5fa' },
    { name: 'Air India', avgFare: 5860, change30d: 7.8, marketShare: 24.6, color: '#22d3ee' },
    { name: 'SpiceJet', avgFare: 4860, change30d: -1.3, marketShare: 14.9, color: '#34d399' },
    { name: 'Vistara', avgFare: 6940, change30d: 5.5, marketShare: 12.1, color: '#a78bfa' },
    { name: 'Akasa Air', avgFare: 5340, change30d: 9.2, marketShare: 7.2, color: '#fbbf24' },
];
...
const ROUTES = ['DEL → BOM', 'BLR → DEL', 'BOM → BLR', 'DEL → MAA', 'CCU → DEL'];
