...
const DATA_SOURCES = [
  {
    name: "Amadeus API",
    status: "Healthy",
    detail: "Live fare feed · polled every 15 min",
    color: "#34d399",
  },
  {
    name: "DGCA Monthly Data",
    status: "Healthy",
    detail: "Regulatory filing · synced monthly",
    color: "#34d399",
  },
  {
    name: "Route Metadata Cache",
    status: "Degraded",
    detail: "3 routes missing IATA codes — flagged",
    color: "#fbbf24",
  },
  {
    name: "Historical Backfill Job",
    status: "Idle",
    detail: "Last ran 6 days ago · no job scheduled",
    color: "#94a3b8",
  },
];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const recordsMetric = document.querySelector(
    "#metric-records-ingested .metric-value",
  );
  if (recordsMetric) {
    animateValue(recordsMetric, 0, 18942, 1200, (v) =>
